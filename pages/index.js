      ...
      <div className="container my-12 mx-auto px-4 md:px-12">
        <div className="p-4">
          <h1 className="text-gray-700 leading-normal">
            Hello I'm <span className="text-purple-500">Liandi Haikal,</span>
          </h1>
          <p className="text-gray-700 leading-normal">
            {" "}
            I'm <span className="text-purple-500">Web Developer</span> or{" "}
            <span className="text-purple-500">Programmer</span>,{" "}
          </p>
          <p className="text-gray-700 leading-normal">
            Contact Me :
              ...
              <div className="max-w-sm rounded overflow-hidden shadow-lg">
                <div className="px-6 py-4">
                  ...
                  <div className="px-2 py-4">
                    <span className="inline-block bg-gray-200 hover:bg-purple-700 hover:text-white rounded-full px-3 py-1 text-sm font-semibold text-purple-700 mr-2">
                      {data.tag}
                    </span>
                  </div>
